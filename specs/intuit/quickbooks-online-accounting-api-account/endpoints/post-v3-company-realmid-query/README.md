...
Query accounts using POST

Execute a QuickBooks SQL-like query selecting from `Account` by sending the query statement in the request body with content type `application/text`.
