...
```
{
  "href": "https://api.ebay.com/sell/compliance/v1/listing_violation?limit=10&offset=0",
  "limit": 10,
  "listingViolations": [
    {
      ...
      "violations": [
        {
          ...
          "message": "Missing required aspect: Color",
